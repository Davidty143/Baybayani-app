<template>
    <div id="MainLayout" class="w-full fixed z-50">
        <div id="MainHeader"
            class="flex items-center w-full bg-[#fafafa] shadow-[0px_4px_10px_5px_rgba(0,_0,_0,_0.25)]">
            <div class="flex lg:justify-start justify-between gap-10 max-w-[1150px] w-full px-3 py-5 mx-auto ">
                    ...
                    <div class="relative">
                        <div class="flex items-center border-2 border-[#0C6539] rounded-md w-full">
                            <input class="
                                    ...
                                    pl-3
                                    focus:outline-none
                                " placeholder="Tomato" type="text" v-model="searchItem">
                ...
                ">
                        <li @mouseenter="isAccountMenu = true" @mouseleave="isAccountMenu = false"
                            ...
                            <span class="ml-2">Account</span> <!-- Add margin-left to space the text from the icon -->
                            ...
                            <div id="AccountMenu" v-if="isAccountMenu"
                                ...
                                <div v-if="!user">
                                    <div class="text-semibold text-[15px] my-4 px-3">Welcome to Baybani!</div>
