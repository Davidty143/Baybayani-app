            ...
            <div class="md:flex gap-4 justify-between mx-auto w-full">
                ...
                <div class="md:w-[60%] bg-white p-3 rounded-lg">
                    <div v-if="product && product.data">
                        <p class="mt-5 mb-2 text-3xl font-semibold">{{ product.data.title }}</p>
                        <p class="font-light 11px]text-[ py-4">{{ product.data.description }}</p>
                    </div>
                    ...
                    <div class="flex items-center justify-start gap-2 my-2">
                        <div class="text-3xl font-bold p-2 text-[#FF5353]">₱ {{ priceComputed }}</div>
                        <span
                            class="bg-[#0C6539] border text-[#fafafa] text-[12px] font-semibold px-1.5 rounded-sm">Vegetables</span>

                        <span class="bg-[#F5F5F5] border text-[#C08562] text-[12px] font-semibold px-1.5 rounded-sm">Top
                            selling</span>
                    </div>
